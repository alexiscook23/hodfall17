...
- First, keep coding! These skills will atrophy if you don't use them. Use R and Rstudio at work. Use it for your next paper. Use it to figure something out in your life. Take a gnarly spreadsheet that some organization uses and turn it into a nice piece of R code. 
...
- Another progrmming language: the other language that's used a lot for Data Science is Python, which is a better general scripting language but a worse statistical programming language. 
...
TODO: Add list of Vandy classes 
