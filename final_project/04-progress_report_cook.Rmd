...
```{r univariate plot}
#should figure out how to make it interactive and show the abbreviation state names when you gloss over
#ggplotly label is abbreviation; aes(text=abbreviation) along w x and y 

## Plot by rank
gg<-ggplot(data=filter(coal_laws_total,abbreviation!="LA"),                      aes(x=percent_change_rank,y=percent_change_emissions))
...
##drop LA from the df to increase accuracy
...
could build out the variables a little more (fees collected, more types of laws etc)
